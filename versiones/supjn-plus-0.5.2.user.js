 ...
 *   dejar nota por causa. Las etiquetas, los apuntes y las notas se copian con
...
(function () {
  ...
  const refrescarVisto = () => { VISTO = normalizarVisto(leerAlmacen(K_VISTO, {})); HAY_FOTO = Object.keys(VISTO).length > 0; };
  ...
  function guardarVisto() {
    ...
    if (!guardarAlmacen(K_VISTO, VISTO)) avisar('No se pudieron guardar las novedades: el almacén del navegador está lleno.', true);
  }
