...
(function () {
  ...
  function medidas() {
    ...
    win.style.minWidth = Math.min(520, Math.max(200, innerWidth - 8)) / z + 'px';
    win.style.minHeight = Math.min(320, Math.max(160, innerHeight - 8)) / z + 'px';
  }
  ...
  if (location.hostname === 'pruebas.supjn.invalid' && typeof window.__SUPJN_PRUEBAS__ === 'function') {
    window.__SUPJN_PRUEBAS__({
      ...
      mismoExpediente, textoVisible, sinRotulo, esPDF, sinNumeroDeCausa, normalizarNotas, normalizarMarcas, validarDatos,
      enterosExactos, anchosEncuadrados, repartirEncuadre, minCol, anchoDe, CFG, COLS_DEF, COLS_ACT_DEF,
