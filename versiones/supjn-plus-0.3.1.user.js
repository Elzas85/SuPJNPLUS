...
(function () {
  ...
  function valorOrden(c, k) {
    ...
    if (k === 'ult') {
      ...
      return String(numFecha(c.ult)).padStart(8, '0') + '|' + String(999999 - p).padStart(6, '0');
    }
  ...
  function alClic(e) {
    ...
    switch (a) {
      ...
      case 'ordenPJNLista': {
        ...
        // Si ya estaban así, el botón parecía no hacer nada: ahora lo dice.
        avisar(yaEstaba
          ? 'Ya estaban en orden cronológico: por última actuación, de la más nueva a la más vieja.'
          : 'Ordenadas por última actuación, de la más nueva a la más vieja, como el PJN.');
        return;
      }
