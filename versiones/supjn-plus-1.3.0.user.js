...
(function () {
  ...
  function cedulaEnNotif() {
    ...
    const opcionCamara = () => [...document.querySelectorAll(PJN.cedula.opcion)]
    ...
    async function elegirCamara(cam) {
      ...
      for (const abrir of formas) {
        ...
        const lista = await esperarQue(() => (document.querySelector(PJN.cedula.opcion) ? true : null), 2500);
        if (!lista) continue;
        abrio = true;
      ...
      return abrio ? 'sin opción' : 'sin lista';
    }
    ...
    (async () => {
      ...
      if (r0.camara !== 'elegida') {
        // Se dice cuál de las dos cosas pasó: el formulario no abrió la lista, o
        // la abrió y ninguna opción trae la sigla. Eso es lo que hace falta para
        // arreglarlo sin adivinar.
        cartel('se cargaron el número y el año de ' + buscado + ', pero ' + (r0.camara === 'sin lista'
          ? 'el formulario no dejó abrir la lista de jurisdicción'
